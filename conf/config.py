...
CENTRAL_WALLET = 'MWTnNuUFqBEEvKtEafu8XFfinqQWRx8iZc'

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 14039
COINDAEMON_TRUSTED_USER = 'karpelescoinrpc'
COINDAEMON_TRUSTED_PASSWORD = '2vvDjEshuyaGgCSFg368pamPQViy1Z9wYWqSNQZcpacF'
...
DB_PGSQL_DBNAME = 'root'
DB_PGSQL_USER = 'r'
DB_PGSQL_PASS = '**empty**'
DB_PGSQL_SCHEMA = 'public'
# MySQL
DB_MYSQL_HOST = 'localhost'
DB_MYSQL_DBNAME = 'root'
DB_MYSQL_USER = 'root'
DB_MYSQL_PASS = 'root'
...
VDIFF_MAX_TARGET = 8               # Maximum Target difficulty 
...
MEMCACHE_PREFIX = "stratummeth_" # Prefix for keys
